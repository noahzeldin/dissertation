...
# 10. Additional Evidence for Claims made in Ch. 2

The following code provides evidence for claims made in ch. 2 but for which there are no corresponding in-line code values or code in above sections.
