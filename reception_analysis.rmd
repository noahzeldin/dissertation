...
## Visual Summary of Reduced Corpus (Fancy Boxplot)

Still need to fix display of observation counts.
...
Want to identify long articles in Measures - Unknown  
* really strech out boxplot
...
## Wordclouds - CAN'T SAVE AS OBJECT
...
Mutter - Grouped by GPO (no unknown)

NB: A bit different than in old version - probably because of modifications to dictionary.
...
```{r}
ca_mass <- plot(grouped_ca_no_erfurt_or_unknown,
     invisible = "row",
     col.quali.sup = "darkblue",
     selectCol = "contrib 20",
     autoLab = "y",
...
```{r}
ca_mutter <- plot(grouped_ca_no_erfurt_or_unknown,
     invisible = "row",
     col.quali.sup = "darkblue",
     selectCol = "contrib 20",
     autoLab = "y",
