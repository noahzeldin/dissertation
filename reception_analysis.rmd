...
original data set, which was removed in the process of converting the data to 
corpora and **dfm**'s. It must therefore be added back in. However, the 
corpora and **dfm**'s must first be converted to dataframes. 
...
# add GPO column from corp_reduced to gen_datafr_reduced
