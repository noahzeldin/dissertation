...
Can prob delete eventually

```{r}
dates_tib$Date %>% str_detect("[:digit:]{2}\\.[:digit:]{2}\\.[:digit:]{4}")
dates_tib$Date %>% str_detect("\\S{2}\\.\\S{2}\\.[:digit:]{4}")
```
...
### Range / Interval - PROBABLY WANT TO SAVE AS VARIABLE FOR WRITE-UP

#### All

Save General Start and End Dates
...
save date of premiere (BFA 3: 431)
...
save date of premiere (BFA 3: 478)
