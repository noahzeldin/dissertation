...
dict_gen <- dictionary(list(revolution = "revolution*",
                            ...
                            chor = c("chor*", "chöre*"), # amended 12.23.20
                            proletarisch = "prolet*",
                            marxismus = "marx*",
                            primitiv = "primitiv*",
                            lehrstück = "lehrstück*",
                            ...
                            lied = c("lied*", "song*"),
                            arbeitersänger = "arbeitersänger*", # 12.23.20
                            arbeiterchor = "arbeiterch*", # 12.23.20
                            bolschewismus = c("bolschewis*",
                                              "kulturbolschewis*"), # 12.18.20 - don't need
                            langweilig = c("langweilig*", # 12.18.20
                                           "langeweile")))
```
...
dict_regex <- dictionary(list(lehrlern = c("lehr(?!s)[a-z]+", 
                                           "belehr(?!s)[a-z]+", # 12.18.20
                                           "lern[a-z]+",
                                           "erlern[a-z]+", # 12.18.20
                                           "gelern[a-z]+", # 12.18.20
                                           "pädagog[a-z]+", # 12.18.20
                                           "didakt[a-z]+"))) # 12.18.20
```
