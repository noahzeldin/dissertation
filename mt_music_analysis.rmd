...
dissertation. The data sets will be made available to researchers upon request.

NB: I have tried to use [tidyverse](https://www.tidyverse.org/) syntax as consistently as possible.
