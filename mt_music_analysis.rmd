...
[*The Measures Taken*](https://www.universaledition.com/hanns-eisler-199/works/die-massnahme-2040), 
which is included in the second chapter of my 
dissertation. The corresponding excerpt is available [here](https://github.com/noahzeldin/dissertation/blob/main/mt_music_analysis_write_up.md).

The analysis was conducted in [R](https://www.r-project.org/). 
...
### Percentages of duple and triple meters
...
### Tables for Top 5 Pieces by Meter Change Count and Rate
...
save.image(file = "C:/Users/Noah Zeldin/Documents/R stuff/R projects/dissertation/mt_music_analysis_files/mt_music_analysis.Rdata")
```
