...
### Meter and Tempo rates of change
...
* same as above but only top 5 for table in write-up - maybe move down, I dunno
...
sorted by **tempo_ch_rate_sec** ASCENDING  
...
tempo_ch_count_and_rate_piece
```

### Most common meters

Create table with meter, non_of_mm and duration.
...
Most common meters by no_of_mm.
